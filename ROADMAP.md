...
* **UI integration approach** — FoxML Core provides APIs and integration points for external dashboards. A native UI layer is optional and out of scope for the core infrastructure.
