...
> **No Obligations Created:** This is an internal policy summary provided for informational purposes only and does not create any SLA, guarantee, or obligation. This document does not grant any license rights. All rights and restrictions are defined solely in `COMMERCIAL_LICENSE.md`.
