...
def print_license_banner(suppress: bool = False):
    ...
    banner_lines = [
        ...
        "",
        "⚠️  ALL USE REQUIRES A COMMERCIAL LICENSE",
        "",
        "FoxML Core is source-available. All use requires a paid license.",
        "No exceptions: personal use, academic use, business use, or any other use.",
        "",
        "💰 COMMERCIAL LICENSING:",
        "Commercial licensing is per team/desk and starts in the six",
        "figures annually. Paid pilot required for evaluation.",
        "",
        "All evaluation requires a paid Pilot. No exceptions.",
        "If you want to use or evaluate the Software, it's a paid pilot",
        "($35k–$75k, credited 100% to Year 1 if converted within 60 days).",
        "",
        "For pricing and packages, see DOCS/02_reference/commercial/COMMERCIAL.md",
        ...
        "💰 Commercial Pricing: DOCS/02_reference/commercial/COMMERCIAL.md",
        ...
        "  - DOCS/02_reference/commercial/COMMERCIAL.md (pricing and packages)",
