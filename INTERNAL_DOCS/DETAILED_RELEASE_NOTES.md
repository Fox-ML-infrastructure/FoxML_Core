# Detailed Release Notes — Internal

This file contains comprehensive, detailed release notes for internal reference. For the public-facing changelog, see `CHANGELOG.md` in the repository root.
...
- **Fixed (2025-12-13)**: Feature selection critical fixes - shared harness unpack crashes, CatBoost dtype mis-typing, RFE/linear model failures, stability cross-model mixing, telemetry scoping issues, uniform importance fallback pollution. Last-mile improvements: failed model skip reasons, feature universe fingerprint for stability tracking.
...
- **Documentation structure reorganization**:
  ...
  - Moved all TRAINING documentation to `docs/` folder:
    ...
    - Created minimal `TRAINING/README.md` and `TRAINING/EXPERIMENTS/README.md` that points to docs
